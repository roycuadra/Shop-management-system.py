...
def addProd(): 
    ...
    labelFrame = Frame(wn, bg='#00ccff',bd=5)
    ...
    #Add Button
    Btn = Button(wn,text="ADD",bg='blue', fg='white',command=prodtoTable)
    Btn.place(relx=0.28,rely=0.85, relwidth=0.18,relheight=0.08)
    
    Quit= Button(wn,text="Quit",bg='red', fg='white',command=wn.destroy)
...
def delProd(): 
    ...
    headingFrame1 = Frame(wn,bg="black",bd=5)
    headingFrame1.place(relx=0.25,rely=0.1,relwidth=0.5,relheight=0.13)
    headingLabel = Label(headingFrame1, text="Delete Product", fg='black', font=('Courier',15,'bold'))
    headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)
    
    labelFrame = Frame(wn,bg='#00ccff')
    ...
    #Delete Button
    Btn = Button(wn,text="DELETE",bg='blue', fg='white',command=removeProd)
...
def newCust():    
    ...
    Btn= Button(wn,text="Generate Bill",bg='#d1ccc0', fg='blue',command=bill)
    Btn.place(relx=0.28,rely=0.9, relwidth=0.18,relheight=0.08)
...
headingFrame1 = Frame(wn,bg="black",bd=5)
headingFrame1.place(relx=0.2,rely=0.1,relwidth=0.6,relheight=0.16)
headingLabel = Label(headingFrame1, text="Shop Management System", fg='black', font=('Courier',15,'bold'))
headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)

#Button to add a new product
btn1 = Button(wn,text="Add a Product",bg='blue', fg='white', width=20,height=2, command=addProd)
btn1['font'] = font.Font( size=12)
btn1.place(x=70,y=200)

#Button to delete a product
btn2 = Button(wn,text="Delete a Product",bg='blue', fg='white',width=20,height=2,command=delProd)
btn2['font'] = font.Font( size=12)
btn2.place(x=400,y=200)

#Button to view all products
btn3 = Button(wn,text="View Products",bg='blue', fg='white',width=20,height=2,command=viewProds)
btn3['font'] = font.Font( size=12)
btn3.place(x=70,y=335)

#Button to add a new sale and generate bill
btn4 = Button(wn,text="New Customer",bg='blue', fg='white', width=20,height=2,command = newCust)
btn4['font'] = font.Font( size=12)
btn4.place(x=400,y=332)
